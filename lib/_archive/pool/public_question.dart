...
class PublicQuestion {
  ...
  ///
  /// Artık havuz/gelen soru yükünde GELMİYOR (bkz. 0035 göçü): cevabı
  /// istemciye önceden vermek, doğruluğu sunucuya taşımayı anlamsız
  /// kılıyordu. Yalnızca cevap verildikten sonra submit_*_answer yanıtından
  /// doldurulur; o ana kadar null'dır.
  ...
  factory PublicQuestion.fromRow(Map<String, dynamic> row) {
    ...
    return PublicQuestion(
      ...
      options: options,
      // correct_index artık görünümde yok; cevap sonrası doldurulur.
