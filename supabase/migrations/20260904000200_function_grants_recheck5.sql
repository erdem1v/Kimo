-- 0056 — Fonksiyon yetkisi beyaz listesi (Task 04 kapısı)
--
-- 0029, 0033, 0038, 0049 ve 0054 ile aynı kapı, güncellenmiş listeyle. Postgres her
-- YENİ fonksiyonda EXECUTE'u tekrar PUBLIC'e verdiği için bu kontrol her paketin
-- sonunda tekrarlanıyor. Task 04'ün eklediği çağrılabilir fonksiyon:
--   notification_lines → yerel bildirim metinlerinin salt-okuma kaynağı
--
