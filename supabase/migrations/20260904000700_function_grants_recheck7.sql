-- 0061 — Fonksiyon yetkisi beyaz listesi (Task 06 / P5 kapısı)
--
...
--
-- Task 06 / P5'in eklediği çağrılabilir fonksiyonlar (0060):
--   ai_cache_get / ai_cache_put → fotoğraf hash'i sonuç önbelleği. Edge
--       fonksiyonu bunları ÇAĞIRANIN JWT'siyle çağırıyor (consume_ai_use ile
--       aynı desen), yani `authenticated`'a açık olmak ZORUNDA.
-- prune_ai_result_cache listede DEĞİL: yalnızca pg_cron çağırır.
--
