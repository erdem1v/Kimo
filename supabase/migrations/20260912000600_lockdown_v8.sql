-- 0084 — Kolon kilidi v8 (`ai_calls.refunded_at`) — Task 12 · P5
--
-- 0026/0036/0047/0053/0064/0069/0073/0077 ile aynı desen. NEDEN YENİ BİR GÖÇ:
-- her lockdown bloğu YALNIZCA kendi çalıştığı andaki katalogla karşılaştırma
-- yapıyor; 0083'ün eklediği sütun 0077 koşarken henüz yoktu. Eskisini
-- güncellemek YETMEZ — (b) kontrolü "sınıflandırılmamış kolon" diye patlar ve
-- `db reset`i tümden kırar.
--
-- v7'den TEK fark: `public.ai_calls.refunded_at` → KİLİTLİ.
--
-- NEDEN KİLİTLİ: sütun kotayı serbest bırakıyor. Yazılabilir olsaydı kullanıcı
-- kendi çağrılarını iade edilmiş işaretleyip SINIRSIZ hak açardı — 0077'nin
-- "bir satır SİLİNEBİLSE kendine sınırsız hak açardı" uyarısının aynısı,
-- silmeden. Tek yazma yolu `refund_ai_use` definer fonksiyonu.
