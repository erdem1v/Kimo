...
export const TAXONOMY: Record<Curriculum, ByExam> = {
  eski: {
    ...
    AYT: {
      "Matematik": [
        "Fonksiyonun Grafikleri ile İlgili Uygulamalar", "Fonksiyon Grafiğinin Eksenleri Kestiği Noktalar, Fonksiyonun Pozitif ve Negatif Olduğu Aralıklar", "Fonksiyonun Artan ve Azalan Olduğu Aralıklar, Bir Fonksiyonun Maksimum ve Minimum Değerleri",
        "Ortalama Değişim Hızı", "İkinci Dereceden Bir Değişkenli Fonksiyonun Grafiğinin Çizimi", "Parabolün Tepe Noktası, Simetri Ekseni ve Görüntü Kümesi ile İlgili Uygulamalar",
        "Parabolün Grafik Çizimi", "Bazı Elemanları Verilen Parabol Denklemini Yazma", "Bir Parabol ile Bir Doğrunun Birbirlerine Göre Durumları",
        "İkinci Dereceden Fonksiyonlarla Modellenebilen Problemler", "Tek ve Çift Fonksiyonların Grafiklerinin Simetri Özellikleri", "İkinci Dereceden İki Bilinmeyenli Denklem Sistemleri",
        "İkinci Dereceden Bir Bilinmeyenli Eşitsizliklerin Çözüm Kümesi", "İki İfadenin Çarpımı ve Bölümü Şeklinde Verilen Eşitsizliklerin Çözüm Kümesi", "İkinci Dereceden Bir Bilinmeyenli Eşitsizlik Sistemleri",
        "Koşullu Olasılık", "Bağımlı ve Bağımsız Olayların Olasılıkları", "Bileşik Olayların Olasılığı",
        "Deneysel ve Teorik Olasılık", "Yönlü Açılar ve Esas Ölçü", "Birim Çember",
        "Sinüs ve Kosinüs Fonksiyonları", "Tanjant ve Kotanjant Fonksiyonları", "Sekant ve Kosekant Fonksiyonları",
        "Trigonometrik Fonksiyonların Açı Değerlerine Göre Sıralanması", "Bir Açının Trigonometrik Değerlerinin Dar Açı Cinsinden Yazılması", "Kosinüs Teoremi",
        "Sinüs Teoremi", "Periyot ve Periyodik Fonksiyon", "Trigonometrik Fonksiyonların Grafikleri",
        "Ters Trigonometrik Fonksiyonlar", "Sinüs ve Kosinüs Fonksiyonlarının Toplam Fark Formülleri", "Tanjant ve Kotanjant Fonksiyonlarının Toplam Fark Formülleri",
        "Sinüs ve Kosinüs Fonksiyonlarının İki Kat Açı Formülleri", "Tanjant ve Kotanjant Fonksiyonlarının İki Kat Açı Formülleri", "sinx=a, cosx=a, tanx=a ve cotx=a Denklemlerinin Çözüm Kümesi",
        "Lineer ve Homojen Denklemlerin Çözüm Kümesi", "Üstel Fonksiyon ve Üstel Fonksiyonun Grafiği", "Logaritma Fonksiyonu ve Logaritma Fonksiyonunun Grafiği",
        "10 ve e Tabanında Logaritma Fonksiyonu", "Logaritma Fonksiyonunun Özellikleri", "Üstel ve Logaritmik Denklemler",
        "Üstel ve Logaritmik Eşitsizlikler", "Gerçek Hayat Durumları ile İlgili Üstel ve Logaritmik Fonksiyon Problemleri", "Dizi Kavramı ve Dizinin Terimleri",
        "Dizi Çeşitleri ve İndirgeme Bağıntısı", "Aritmetik Dizi ve Özellikleri", "Geometrik Dizi ve Özellikleri",
        "Aritmetik ve Geometrik Dizilerde Sonlu Toplamlar", "Gerçek Hayat Durumları ile İlgili Dizi Problemleri", "Limit Kavramı",
        "Limit Özellikleri ve Uygulamaları", "Limitte Belirsizlik Durumları ve Uygulamaları", "Süreklilik",
        "Türev Kavramı", "Türev Alma Kuralları", "Türevlenebilen İki Fonksiyonun Toplamının, Farkının, Çarpımının ve Bölümünün Türevi",
        "İki Fonksiyonun Bileşkesinin Türevi", "Bir Fonksiyonun Artan ve Azalan Olduğu Aralıklar", "Bir Fonksiyonun Ekstremum Noktaları",
        "Türev Yardımıyla Bir Fonksiyonun Grafiğinin Çizimi", "Maksimum ve Minimum Problemleri", "Belirsiz İntegral ve İntegral Alma Kuralları",
        "Değişken Değiştirme Yöntemi", "Riemann Toplamı", "Belirli İntegral Kavramı",
        "Belirli İntegralin Özellikleri", "Belirli İntegral ile Alan Hesabı", "İki Fonksiyonun Grafiği Arasında Kalan Sınırlı Bölgenin Alanı",

      ],
      "Geometri": [
        "Analitik Düzlem", "Analitik Düzlemde İki Nokta Arasındaki Uzaklık", "Bir Doğru Parçasının Orta Noktası ve Üçgenin Ağırlık Merkezinin Koordinatları",
        "Doğrunun Eğimi", "Doğru Denklemleri", "Doğrunun Grafiği, Doğruların Birbirlerine Göre Durumları",
        "Bir Noktanın Bir Doğruya Uzaklığı, Paralel İki Doğru Arasındaki Uzaklık", "Bir Doğru Parçasını Belirli Bir Oranda İçten ve Dıştan Bölen Noktanın Koordinatları", "Çemberin Standart Denklemi",
        "Özel Çember Denklemleri", "Çemberin Genel Denklemi", "Bir Doğru ile Bir Çemberin Birbirine Göre Durumları",
        "Öteleme Dönüşümü", "Dönme Dönüşümü", "Simetri Dönüşümü",
        "Temel Dönüşümlerin Bileşkeleri", "Çemberde Teğet, Kiriş, Çap, Yay ve Kesen", "Çemberde Kirişin Özellikleri",
        "Çemberde Merkez Açı ve Çevre Açı", "Çemberde Teğet-Kiriş Açı ve İç-Dış Açı", "Çevrel Çember, Çemberde Sinüs Teoremi, Çemberde Teğet Özellikleri, Üçgenin İç Teğet ve Dış Teğet Çemberleri",
        "Dairenin Çevresi ile Daire Diliminin Çevresi", "Dairenin Alanı ve Daire Diliminin Alanı", "Dik Dairesel Silindirde Uzunluk ve Alan",
        "Dik Dairesel Silindirde Hacim", "Dik Dairesel Konide Uzunluk ve Alan", "Dik Dairesel Konide Hacim",
